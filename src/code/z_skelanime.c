...
void SkelAnime_AnimationType5Loaded(GlobalContext* globalCtx, AnimationEntryType5* entry) {
    ...
    actor->posRot.pos.x += (pos.x * actor->scale.x) * entry->unk08;
    actor->posRot.pos.y += (pos.y * actor->scale.y) * entry->unk08;
    actor->posRot.pos.z += (pos.z * actor->scale.z) * entry->unk08;
}
